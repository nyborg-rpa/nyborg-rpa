...
def scan_medcom_letters_and_send_report(*, recipients: list[str]):
    ...
    sp_keywords_list = (
        ...
        .lists.get_by_name(name="01.57.02 Kompressionsord liste")
        .items.get_all()
        .expand(["fields"])
        .execute_query()
    )
    ...
    sp_prev_letters_list = (
        ...
        .lists.get_by_name("01.57.01  Sundhed og Ældre - Kompressionsklinik - Medcom scanner")
        .items.get_all()
        .expand(["fields"])
        .execute_query()
    )
...
def compression_scan_medcom_letters(*, recipients: list[str]):
...
if __name__ == "__main__":
    dispatch_pad_script(fn=compression_scan_medcom_letters)
